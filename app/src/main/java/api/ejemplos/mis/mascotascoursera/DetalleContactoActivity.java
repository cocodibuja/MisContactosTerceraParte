...
public class DetalleContactoActivity extends AppCompatActivity {
    ...
    public void enviarMail(View v){
        ...
        intentEnviarEmail.setData(Uri.parse("mailto"));
        intentEnviarEmail.putExtra(Intent.EXTRA_EMAIL , email);
        intentEnviarEmail.setType("message/rfc822");
        startActivity(intentEnviarEmail.createChooser(intentEnviarEmail ,"EMAIL"));
